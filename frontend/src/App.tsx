...
function Welcome() {
  return(
    <div>
      <h1>Welcome to the 2023 NCAA March Madness Info Page</h1>
      <p>This site details information about the teams involved in this year's tournament</p>
    </div>
  );
}
...
function TeamList() {
  return(
    <div>
      <h3>Team List:</h3>
      {teams.map(oneSchool => <SchoolName {...oneSchool}/>)}   
    </div>
  )
}
  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <div className="row">
           <div className="column left App-teamList">
          <TeamList></TeamList>
          </div>
